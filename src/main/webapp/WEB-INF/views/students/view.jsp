...
<div class="flex h-screen">
  ...
  <div class="w-64 bg-primary-dark text-white">
    <div class="p-4 bg-red-600">
      ...
      <span class="font-bold ml-2">FRONTIER INSTITUTE</span>
    </div>

    <nav class="mt-6">
      <a href="${pageContext.request.contextPath}/dashboard" class="flex items-center py-3 px-4 hover:bg-primary transition duration-200">
        <i class="fas fa-tachometer-alt w-6"></i>
        <span>Dashboard</span>
      </a>

      <a href="${pageContext.request.contextPath}/students" class="flex items-center py-3 px-4 bg-primary">
