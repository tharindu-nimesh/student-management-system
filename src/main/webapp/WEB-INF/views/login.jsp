...
<div class="flex flex-col lg:flex-row min-h-screen">
    ...
    <div class="w-full lg:w-1/2 gradient-bg flex flex-col justify-center items-center p-8 lg:p-16 text-center lg:text-left relative overflow-hidden">
        <!-- Background Shapes -->
        ...
        <div class="relative z-10 animate-fade-in">
            <div class="float-animation mb-8">
                <img src="${pageContext.request.contextPath}/images/logo.png" alt="Frontier Institute Logo" class="w-24 h-24 mx-auto lg:mx-0 shadow-lg rounded-xl">
            </div>
            <h1 class="text-white text-3xl lg:text-5xl font-bold mt-4">FRONTIER INSTITUTE</h1>
            <div class="h-1 w-20 bg-white mx-auto lg:mx-0 my-6"></div>
            <h2 class="text-white text-4xl lg:text-6xl font-bold mt-6 animate-slide-up" style="animation-delay: 0.2s;">WELCOME</h2>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div class="glass-effect w-full max-w-md rounded-2xl shadow-xl p-8 animate-fade-in" style="animation-delay: 0.3s;">
