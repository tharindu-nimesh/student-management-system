...
<head>
    <meta charset="UTF-8">
    <title>Edit Teacher - Nimna Institute</title>
        ...
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-8">
            ...
            <form action="${pageContext.request.contextPath}/teachers/update" method="post" class="space-y-6">
                ...
                <div class="flex justify-end">
                    ...
                    <button type="submit" class="bg-[#3047D5] hover:bg-[#2536a9] text-white font-semibold py-2 px-6 rounded">Update Teacher</button>
                </div>
            </form>
        </div>
    </main>
